    ...
    var app = new Vue({
        ...
        methods: {
            ...
            cat: function (item, index) {
                ...
                item.selected = true;
                $.loading();
                axios.get(`/report/getSinglePaymentData?id=${item.id}&start=${this.start}&end=${this.end}`)
                    .then(function (res) {
                        $.loaded();
            ...
            loadData: function () {
                ...
                axios.get(`/report/getPaymentData?start=${this.start}&end=${this.end}`)
                    .then(function (res) {
            ...
            exportData: function () {
                location = `/report/exportPaymentData?start=${this.start}&end=${this.end}`;
            },
            info: function (item) {
                $.view({
                    title: "订单详情",
