    ...
    var app = new Vue({
        ...
        methods: {
            ...
            cat: function (item) {
                ...
                item.selected = true;
                $.loading();
                axios.get(`/report/getSingleThirdBoothData/${item.id}?start=${this.start}&end=${this.end}&type=${this.type}`)
                    .then(function (res) {
                        $.loaded();
            ...
            loadData: function () {
                var self = this;
                axios.get(`/report/getThirdBoothData?start=${this.start}&end=${this.end}&type=${this.type}`)
                    .then(function (res) {
            ...
            exportData: function () {
                location = `/report/exportThirdBoothData?start=${this.start}&end=${this.end}&type=${this.type}`;
            }
        },
        created: function () {
            this.loadData();
