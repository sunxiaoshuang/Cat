    ...
    var app = new Vue({
        ...
        methods: {
            ...
            catCook: function (item) {
                ...
                item.selected = true;
                $.loading();
                axios.get(`/report/getSingleThirdCookData/${item.id}?start=${this.start}&end=${this.end}&type=${this.type}`)
                    .then(function (res) {
                        $.loaded();
            ...
            loadData: function () {
                var self = this;
                axios.get(`/report/getThirdCookData?start=${this.start}&end=${this.end}&type=${this.type}`)
                    .then(function (res) {
            ...
            exportData: function () {
                location = `/report/exportThirdCookData?start=${this.start}&end=${this.end}&type=${this.type}`;
            }
        },
        created: function () {
            this.loadData();
